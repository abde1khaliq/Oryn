...
@router.post(
    ...
    description="""
    Adds an existing workspace member to a team. Only owners can add members. The user must already belong to the same workspace.
    """
)
@limiter.limit("5/minute")
